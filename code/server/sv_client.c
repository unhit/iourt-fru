...
\0001 through \0011, \0013 and \0014, \0016 through \0032, \0034 through \0040, \0176, and \0177.
...
//			VM_Call( gvm, GAME_CLIENT_DISCONNECT, newcl - svs.clients );
	...
	if ( !newcl ) {
		if ( NET_IsLocalAddress( from ) ) {
			...
			//NET_OutOfBandPrint( NS_SERVER, from, "print\nServer is full.\n" );
			sprintf(serverFullMessage, "print\n%s\n", sv_serverFullMessage->string);
			NET_OutOfBandPrint( NS_SERVER, from, serverFullMessage);
