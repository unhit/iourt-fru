...
void SV_Init (void) {
	...
	sv_demonotice = Cvar_Get ("sv_demonotice", "Big Brother is watching you!", CVAR_ARCHIVE);

	sv_serverFullMessage = Cvar_Get ("sv_serverFullMessage", "Server is full", CVAR_ARCHIVE);
